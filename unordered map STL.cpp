...
int main()
{
	...
	//check
	for (unordered_map <int, string>::iterator i = umap2.begin(); i != umap2.end(); i++) // i is nothing but name given to iterator 
	{
		cout << i->first << " ";
		cout << i->second << endl;
	}
	...
	unordered_map<int, string>::iterator del = umap2.begin(); // here del is the name of iterator 
	umap2.erase(del);
